<template>
  <div class="app">
   <JumbotronEje title="DESARROLLO SOSTENIBLE" subtitle="Noticias" image="anticorrupcion-thumb.png"/>
...
export default {
  ...
  async asyncData({ $content }) {
    const columnas = await $content("noticias").where({category:"desarrollo-sostenible"}).fetch();
