...
export default {
  ...
  data() {
    return {
      currentUrl:'https://www.ethos.org.mx/desarrollo-sostenible/columnas/'+this.$route.params.slug
    }
  },
  head() {
    return{
      ...
      link: [
        {
          rel: 'canonical',
          href: 'https://www.ethos.org.mx/desarrollo-sostenible/columnas/'+this.$route.params.slug
        }
      ]
    }
  }
