...
export default {
  ...
  data() {
    return {
      ...
      p9:false,
      p10:false,
      puestos: ["DIRECCIÓN GENERAL", "DIRECCIÓN DE DESARROLLO INSTITUCIONAL", "FINANZAS PÚBLICAS Y ANTICORRUPCIÓN", "INCLUSIÓN Y DESARROLLO SOSTENIBLE", "RUMBO DEMOCRÁTICO", "COMUNICACIÓN Y PRENSA", "ADMINISTRACIÓN Y RECURSOS HUMANOS", "PROGRAMA DE INTERNSHIP", "CONSEJO ASESOR", "CONSEJO DIRECTIVO"],         // all of the tabs
      personal: [
