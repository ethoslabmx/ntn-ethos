...
export default {
  ...
  data() {
    return {
      currentUrl:'https://www.ethos.org.mx/anticorrupcion/noticias/'+this.$route.params.slug
    }
  },
  head() {
    return{
      ...
      meta: [
        ...
        { hid: 'og:url', property: 'og:url', content: 'https://www.ethos.org.mx/anticorrupcion/noticias/'+this.$route.params.slug },
      ...
      link: [
        {
          rel: 'canonical',
          href: 'https://www.ethos.org.mx/anticorrupcion/noticias/'+this.$route.params.slug
        }
      ]
    }
  }
