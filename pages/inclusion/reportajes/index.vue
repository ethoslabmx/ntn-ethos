<template>
  <div class="app">
    <JumbotronEje title="INCLUSIÓN" subtitle="REPORTAJES PERIODÍSTICOS" image="anticorrupcion-thumb.png"/>
...
export default {
  ...
  async asyncData({ $content }) {
    const eventos = await $content("reportajes").where({category:"inclusion"}).fetch();
