<template>
  <div class="border-b-16 border-primary app">
    <JumbotronEje title="Finanzas públicas" subtitle="Publicaciones" image="anticorrupcion-thumb.png"/>
...
export default {
  ...
  async asyncData({ $content }) {
    const eventos = await $content("publicaciones").where({category:"finanzas-publicas"}).fetch();
