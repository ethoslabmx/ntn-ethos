...
export default {
  ...
  data() {
    return {
      currentUrl:'https://www.ethos.org.mx/ciudades-del-futuro/eventos/'+this.$route.params.slug
    }
  },
  head() {
    return{
      ...
      link: [
        {
          rel: 'canonical',
          href: 'https://www.ethos.org.mx/ciudades-del-futuro/eventos/'+this.$route.params.slug
        }
      ]
    }
  }
