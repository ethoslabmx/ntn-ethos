  ...
  <div>
    ...
    <div class="relacionadas bg-cyan py-12 md:py-20 text-white">
      <div class="container flex items-start flex-wrap xl:flex-nowrap">
        <div class="w-full xl:w-1/6"><h2 class="mb-3 xl:mb-0 saira uppercase text-sm text-white">Artículos relacionados</h2></div>
...
export default {
  ...
  data(){
    return {
      source:'',
      currentUrl:'https://radiant-semifreddo-901f94.netlify.app/ciudades-del-futuro/reportajes/'+this.$route.params.slug
    };
  },
  async asyncData({ $content, params, error }) {
    ...
    try {
      ...
      articulos = await $content('reportajes').where({category:'ciudades-del-futuro'}).limit(3).fetch();
