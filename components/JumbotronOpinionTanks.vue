...
<template>
<div>
    <div class="jumbotron-opinion relative flex items-top justify-center bg-white sm:items-center sm:pt-0 border-t-3  border-b-3 border-black">
      <div class="5xl:px-0 5xl:container pl-6 w-full flex items-center">
        <div class="hero w-full p-5 md:p-0   flex items-center">
         ...
         <div class="h-image w-full md:w-1/2 self-center flex items-center">
          <img src="../assets/images/writer.jpg" alt="" class="h-auto w-full object-contain">
         </div>
        </div>
      </div>
  </div>
